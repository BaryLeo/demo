...
import com.security.jwt.security.SystemUserDetail;
...
public class JwtUtils {
    ...
    private static final String SUBJECT = "leo";

    private static final long EXPIRITION = 1000 * 24 * 60 * 60 * 7;

    private static final String APPSECRET_KEY = "leo_secret";

    private static final String ROLE_CLAIMS = "roles";

    public static String generateJsonWebToken(SystemUserDetail user) {
        String token = Jwts
                .builder()
                .setSubject(SUBJECT)
